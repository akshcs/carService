...
public class CustomerScheduleServiceImpl extends AbstractScheduleServiceImpl {
    @Autowired
    private AppointmentService appointmentService;

    @Override
    public List<Appointment> getAppointmentsFromIdAndTime(long id, TimePeriod timePeriod) {
        return appointmentService.getAppointmentByCustomerAndTime(id, timePeriod.getStart(), timePeriod.getEnd());
    }
}
